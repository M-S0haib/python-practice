...
def show_Mark_Sheet():
    ...
    try:
        ...
        tk.Label(printWindow, text=calculate_Average(totalMarks)).grid(row=10, column=1)
...
def clear_fields():
    ...
    subject1Marks.delete(0, tk.END)
    subject2Marks.delete(0, tk.END)
    subject3Marks.delete(0, tk.END)
    subject4Marks.delete(0, tk.END)
    subject5Marks.delete(0, tk.END)
